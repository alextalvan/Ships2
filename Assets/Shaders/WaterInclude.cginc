...
half4  ExtinctColor (half4 baseColor, half extinctionAmount) 
{
	...
	half3 GerstnerOffset4 (half2 xzVtx, half4 steepness, half4 amp, half4 freq, half4 speed, half4 dirAB, half4 dirCD, float customTime) 
	{
		half3 offsets;
		...
		half4 TIME = half4(customTime,customTime,customTime,customTime) * speed;
		//half4 TIME = half4(_Time.yyyy) * speed;
