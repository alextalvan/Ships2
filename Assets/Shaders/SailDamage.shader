...
////// Specular:
                ...
                float3 diffuseColor = saturate(( _Overlaycolor.rgb > 0.5 ? (1.0-(1.0-2.0*(_Overlaycolor.rgb-0.5))*(1.0-(_Texture_main_var.rgb+_Color.rgb))) : (2.0*_Overlaycolor.rgb*(_Texture_main_var.rgb+_Color.rgb)) )); // Need this for specular when using metallic
