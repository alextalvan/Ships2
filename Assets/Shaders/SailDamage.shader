...
////// Specular:
                ...
                float3 diffuseColor = saturate(( _Color.rgb > 0.5 ? (1.0-(1.0-2.0*(_Color.rgb-0.5))*(1.0-(_Texture_main_var.rgb+_SecColor.rgb))) : (2.0*_Color.rgb*(_Texture_main_var.rgb+_SecColor.rgb)) )); // Need this for specular when using metallic
