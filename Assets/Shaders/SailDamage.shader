    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += (((clamp(sin(((_Frequency*2.0+0.0)*((1.0 - mul(_Object2World, v.vertex).g.r)+node_5117.g+mul(_Object2World, v.vertex).r.r)*_Folds*6.28318530718)),0,1)*0.5)*v.normal*(_Amplitude*4.0+0.0))*o.vertexColor.r);
